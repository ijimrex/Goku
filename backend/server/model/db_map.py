...
class Appointment(BaseModel):
    ...
    user = CharField(db_column='user_id', index=True, null=True)
...
class History(BaseModel):
    battery = ForeignKeyField(db_column='battery_id', null=True, rel_model=Battery, to_field='id')
    bike_model = ForeignKeyField(db_column='bike_model_id', null=True, rel_model=Ebike, to_field='id')
    ebike = CharField(db_column='ebike_id', null=True)
    id = CharField(primary_key=True)
    operation = CharField()
    time = DateTimeField()
    user = ForeignKeyField(db_column='user_id', null=True, rel_model=User, related_name='user_user_set', to_field='id')
